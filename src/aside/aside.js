...
export default function Aside() {
    ...
    const capa = [
        ...
        { id: 3, imagem: photo9, titulo: "Portfólio", descricao: "Portifolio criado em React para poder falar mais sobre meu trabalho, quais ferramentas eu utilizo, ter informações de contatos expondo minhas redes socias como GitHub e linkedin, emails e whatsApp e para falar um pouco mais sobre mim." },
