...
import axios from "../../icons/Azios.png"
...
export default function CarrocelProjeto() {
    ...
    const capa = [
        { id: 1, imagem: photo7, titulo: "Filmes em Cartaz", alt: "Foto dos Filme em Cartaz", descricao: "Este projeto foi desenvolvido para acompanhar filmes em cartaz, com o objetivo de aprimorar a lógica de programação e consumir APIs de forma eficiente.", deployurl: " https://filme-cartaz.netlify.app", githuburl: "https://github.com/FelipeQuadrosdev/Filmes_Cartaz.git", tecnologicas: [react,js,typescriptt,,axios,route], },
        { id: 2, imagem: photo8, titulo: "Web Criptomoedas", alt: "Foto das Criptomoedas", descricao: "Este projeto foi desenvolvido para monitorar criptomoedas, com o objetivo de aprimorar minha lógica de programação e raciocínio lógico.", deployurl: "https://webcriptmoeda.netlify.app", githuburl: "https://github.com/FelipeQuadrosdev/Werbisite_Criptomoedas/tree/main", tecnologicas: [react,js, typescriptt,axios,vite], },
                            ...
                            <div className="content">
                                ...
                                <div className="icones">
                                    {item.tecnologicas.map((icone) => (
                                        <img src={icone} alt="Ícone de tecnologia" className="icone" />
                                    ))}
                                </div>
                            </div>
                        </div>
